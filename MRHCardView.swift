...
@IBDesignable public class MFCardView: UIView {
    ...
    fileprivate func generalSetup(){
       ...
       btnDone.setTitle("Close", for: .normal)
        ...
        txtCardNoP1.addTarget(self, action: #selector(MRHCardView.textFieldDidChange(_:)), for: UIControl.Event.editingChanged)
        txtCardNoP2.addTarget(self, action: #selector(MRHCardView.textFieldDidChange(_:)), for: UIControl.Event.editingChanged)
        txtCardNoP3.addTarget(self, action: #selector(MRHCardView.textFieldDidChange(_:)), for: UIControl.Event.editingChanged)
        txtCardNoP4.addTarget(self, action: #selector(MRHCardView.textFieldDidChange(_:)), for: UIControl.Event.editingChanged)
        txtCvc.addTarget(self, action: #selector(MRHCardView.textFieldDidChange(_:)), for: UIControl.Event.editingChanged)
    ...
    fileprivate func getBundle() -> Bundle {
        ...
        let podBundle = Bundle(for: MRHCardView.self)
    ...
    fileprivate func setImage(_ card : String) {
                ...
                case CardType.MESKTIKA.rawValue:
                    setImageWithAnnimation(UIImage(named: "MESKTIKA", in: mfBundel!,compatibleWith: nil),cardType: CardType.MESKTIKA)
                    break
                
                case CardType.BNI.rawValue:
                    setImageWithAnnimation(UIImage(named: "BNI", in: mfBundel!,compatibleWith: nil),cardType: CardType.BNI)
                    break
        
                case CardType.HCBC.rawValue:
                    setImageWithAnnimation(UIImage(named: "HCBC", in: mfBundel!,compatibleWith: nil),cardType: CardType.HSBC)
                    break
        
                case CardType.BCA.rawValue:
                    setImageWithAnnimation(UIImage(named: "BCA", in: mfBundel!,compatibleWith: nil),cardType: CardType.BCA)
                ...
                case CardType.Mandiri.rawValue:
                    setImageWithAnnimation(UIImage(named: "Mandiri", in: mfBundel!,compatibleWith: nil),cardType: CardType.Mandiri)
                
                case CardType.BRI.rawValue:
                    setImageWithAnnimation(UIImage(named: "BRI", in: mfBundel!,compatibleWith: nil),cardType: CardType.BRI)
                    
                case CardType.BTN.rawValue:
                    setImageWithAnnimation(UIImage(named: "BTN", in: mfBundel!,compatibleWith: nil),cardType: CardType.BTN)
                    
                case CardType.MUAMALAT.rawValue:
                    setImageWithAnnimation(UIImage(named: "MUAMALAT", in: mfBundel!,compatibleWith: nil), cardType: CardType.MUAMALAT)
